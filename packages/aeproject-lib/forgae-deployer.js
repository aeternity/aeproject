...
var forgae_utils_1 = require("forgae-utils");
var fs = require("fs");
var forgae_logger_1 = require("forgae-logger");
var forgae_config_1 = require("forgae-config");
var forgae_config_2 = require("forgae-config");
var decodedHexAddressToPublicAddress = forgae_utils_1.default.decodedHexAddressToPublicAddress;
var ttl = 100;
var opts = {
    ttl: ttl
};
...
var Deployer = /** @class */ (function () {
    ...
    function Deployer(network, keypairOrSecret, compilerUrl, networkId) {
        ...
        if (keypairOrSecret === void 0) { keypairOrSecret = forgae_utils_1.default.config.keypair; }
        if (compilerUrl === void 0) { compilerUrl = forgae_config_1.default.compilerUrl; }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, forgae_utils_1.default.getClient(this.network, this.keypair)];
                    case 1:
                        client = _a.sent();
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    instances = [];
                    _a = [];
                    for (_b in forgae_config_2.default.defaultWallets)
                        _a.push(_b);
                    _i = 0;
                    _c.label = 1;
                case 1:
                    ...
                    wallet = _a[_i];
                    return [4 /*yield*/, forgae_utils_1.default.getClient(network, forgae_config_2.default.defaultWallets[wallet])];
                case 2:
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, forgae_utils_1.default.generateKeyPairFromSecretKey(walletToPass)];
                            case 1:
                                keyPair = _a.sent();
